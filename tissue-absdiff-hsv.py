...
path_img1 ="./my_dir/matigai/ref.jpg"    #250301
path_img2 ="./my_dir/matigai/tar_good_easy.jpg"    #250301
...
if img1 is None:
    print(os.path.basename(path_img1)+'ファイルを読み込めません')
    import sys
    sys.exit()

if img2 is None:
    print(os.path.basename(path_img2)+'ファイルを読み込めません')
    import sys
    sys.exit()
...
H_THRESHOLD = 70    #250301 default:70
...
DIFF_THRESHOLD = 60 #250301 default:60
